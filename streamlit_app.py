...
# HASHED_PASSWORD = os.environ.get("HASHED_PASSWORD").encode("utf-8")🌩️
...
def main():
    ...
    **Demographics:**
    - find the total for all the customers
                        
    **Admissions:**
    - find the total for all the region
    ...
    user_question = st.text_area(
        ...
        height=100, 
        placeholder="find the total for all the region   "
    )
